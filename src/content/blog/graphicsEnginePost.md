...
![](images/scene_cover.png)
![](images/gold_sphere_cover.png)
![](images/chest_cover.png)
...
![position in view space (RGB) + metallic (A)](images/pos_metallic_map.png width=450) ![normal in view space (RGB) + roughness (A)](images/normal_roughness_map.png width=450) 
![albedo (RGB) + ambient occlusion (A)](images/albedo_ao_map.png width=450) ![emissive (RGB)](images/emissive_map.png width=450)
...
![Directional Light Shadow Map](images/dir_light_shadow_map.png height=350 border="1")
...
![X+](images/point_right_shadow_map.png width=200 height=200 border="1") ![X-](images/point_left_shadow_map.png width=200 height=200 border="1") ![Y+](images/point_up_shadow_map.png width=200 height=200 border="1") 
![Y-](images/point_down_shadow_map.png width=200 height=200 border="1") ![Z+](images/point_front_shadow_map.png width=200 height=200 border="1") ![Z-](images/point_back_shadow_map.png width=200 height=200 border="1")
...
![Cook-Torrance Reflectance Equation (this way we know what it looks like).](images/reflect_equ.png)
...
![Point Light](images/point_light.png) 
...
![Equirectangular Map](images/equi_rect.png) 
...
![X+](images/hill_right.png width=300 height=230) ![X-](images/hill_left.png width=300 height=230) ![Y+](images/hill_top.png width=300 height=230) 
![Y-](images/hill_bottom.png width=300 height=230) ![Z+](images/hill_front.png width=300 height=230) ![Z-](images/hill_back.png width=300 height=230) 
...
in green: the specular term part](images/split_equ.png)
...
![X+](images/irr_right.png width=300 height=230) ![X-](images/irr_left.png width=300 height=230) ![Y+](images/irr_top.png width=300 height=230) 
![Y-](images/irr_bottom.png width=300 height=230) ![Z+](images/irr_front.png width=300 height=230) ![Z-](images/irr_back.png width=300 height=230) 
...
![X+](images/pre_right.png width=300 height=230) ![X-](images/pre_left.png width=300 height=230) ![Y+](images/pre_top.png width=300 height=230) 
![Y-](images/pre_bottom.png width=300 height=230) ![Z+](images/pre_front.png width=300 height=230) ![Z-](images/pre_back.png width=300 height=230) 
...
![BRDF Lookup texture](images/brdf_lut.png width=250 height=250)
...
![The scene using IBL](images/pbr_map.png) 
...
![Scene Map with Point Light](images/front_light.png)
...
![Scene Map with Skybox](images/front_pbr_map.png) 
...
![First color attachment of the HDR FBO containing the pixels of the scene](images/front_pbr_map.png) 
![Second color attachment of the HDR FBO containing the bright pixels of the scene](images/front_bright_pbr_map.png)
...
![Down Mip 1: 640x360](images/mip_640x360.png width=300 height=150) ![Down Mip 3: 160x90](images/mip_160x90.png width=300 height=150) ![Down Mip 5: 40x22](images/mip_40x22.png width=300 height=150) 
...
![Up Mip 2: 160x90](images/up_mip_160x90.png width=250 height=150) ![Up Mip 4: 640x360 (final bloom image)](images/up_mip_640x360.png width=250 height=150)
...
![First color attachment of the HDR FBO containing the pixels of the scene](images/front_pbr_map.png) 
![Bloom texture](images/up_mip_640x360.png)
...
![Final Result mixing the scene map and the bloom map with tone mapping and gamma correction.](images/final_scene.png)
