...
Screenshot of the Perforce interface showing our depot. 
...
Screenshot of our Discord server
...
Screenshot of our Roadmap made in Miro
...
Screenshot of the Miro document containing concept art and references.
Finally, we can mention the use of Jira during the first two months of work to assign tasks between programmers.

Screenshot of our Jira board, where we initially assigned sprint tasks at the beginning of the project.
...
Concept art for the game generated using ChatGPT.
## 2.4 Documents
...
Pitch / Creative Vision Document (made on Google Slide): Pitch document / Creative vision: This was used to present our game and our ambitions to the various experts from outside the school who were following our project.

Left image: our GDD. Image top right: our Pitch document. Bottom right: our Global Vision document.
...
Game Audio:
Samuel [...] took on the role of Lead Audio, as he quickly learned how to use Wwise and was highly enthusiastic about working on a game.
Game Programming:
Since the programming team played a central role in the project, multiple leadership positions were assigned.
Remy Lambert became the Product Owner, as the original game pitch was his idea. He also took on the role of Game Designer and Level Designer. Constantin Vérine was assigned as the Producer, leveraging his prior experience in team management. Olivier Pachoud was designated Lead Programmer and also took on the role of Graphics Programmer and Tech Artist, allowing him to specialize in his field of interest for his future job.
...
Screenshot of our very first prototype in July.
## 3.2 August 
...
Screenshot of the Level Design of our Proof of Concept in August.
...
Screenshot of our first Production Prototype which was focused on core mechanics and puzzles.
...
Screenshot of our second Production Prototype which was focused on Game Experience and Storytelling
...
Screenshot of our Preliminary Vertical Slice for the school's submission deadline.
...
At the end of October 2024, following Nicolas Brière's advice, we set up a weekly routine where we would get together as students to talk about the project. Together we would look at each other's work, give feedback, brainstorm and set our sprint goals. These meetings, in parallel with the discord server, were the heart of our teamwork and were extremely enriching. We were able to understand each other's needs and act accordingly. We were also able to create sub-teams of people who worked together on the same aspect of the game, each in their own area of expertise.
...
Screenshot of my gym level where I tested the key and core mechanics of the game. You can see the prototype for the laser mechanic and the white blocks are the capstan mechanic. You can also see my first cel shader render.
...
A laser colour mixing puzzle from the game's playtest days 
to analyse what players found fun.

One of the VFX I did during this period among many others. This one is the power that gives the crystals back their brilliance.
...
Screenshot of the Cel Shader version I validated with the Game Art team. At that point, I wasn't sure I'd have time to continue refining the shader, so I decided to make a stable version that we'd be able to support for the school's delivery date.

Screenshot of our prototype beautiful corner where you can see our narrative work with the frescoes, our Level Art work and my lighting tests with the god rays.
...
Illuminate shadowy areas with a bluish tint
...
Screenshot of the Cel Shader version for the final submission to the school on 14 February.
